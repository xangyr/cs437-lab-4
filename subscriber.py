...
"""
python3 sub.py --hash <device hash> --num  <device id 0-4>
"""
# Read in command-line parameters
parser = argparse.ArgumentParser()
parser.add_argument("-h", "--hass", action="store", dest="key", help="Private key file path")
parser.add_argument("-i", "--id", action="store", dest="num", default="0", help="Number of the subscription")
...
clientId = "ProcessEmission_Subscriber_{}".format(args.id)
thingName = "ProcessEmission_Subscriber_{}".format(args.id)
topic = "emission/car/{}".format(args.id)
mode = "subscribe"
